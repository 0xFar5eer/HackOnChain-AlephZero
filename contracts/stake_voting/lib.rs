    ...
    impl StakeOperatorsVotes {
        ...
        pub fn default() -> Self {
            ink_lang::utils::initialize_contract(|contract: &mut Self| {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5Eo5ZxVUGbT6D8cfAvAxQFhzt3ZqBEb5oE8KCWR9vjvTPSMy"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                    ...
                    total_stakers: 618,
                    vote_points: 0,
                    stake_operator_id: AccountId::from(addr),
                };
                contract
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5GW5kbpuYn8Wa2253xLNLn9dZYWJUPJmW7VwmjnziDWdGxiX"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5CGTtuqDbBQokPQjpa4mQyNKyvYxKpgtZEskDkJxzho1NhbM"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5HYzfrjAMGB6zWW3oTg7dhGdWB8cawyU84fCpGar9QhupweS"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5Dkh7kuPm4NMfkmDG1LaVZVWXW3WHYwh7BKEFfNvPiGDrARH"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5HNnDD5djTaiUt3A6yf6f1E9oDiM5w5fcNBTLLCoMKf1TEdS"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5Grh6bLQmoxinEeiijAfSbGYrYiKhxnxcM2m96s5A64VyAiF"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5DATX2UZZgxAsumbVEsmup2q6LR9Bn81F7KW7PsShgUw8t12"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5FnyjESMB4EBQn1W1vnNKZ5oVUYUmQbTPG4hZbJJm8697TKt"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
                ...
                let pos = contract.length_of_stake_operator_information_list;
                contract.length_of_stake_operator_information_list += 1;
                let addr: [u8; 32] = "5GN3rbR41UYWtjoxeuyvBfWEPopH4C2R4z7qhtz2ysF5hmrt"
                    .as_bytes()
                    .try_into()
                    .unwrap();
                let stake_operator_information = StakeOperatorInformation {
